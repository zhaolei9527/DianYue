...
public class ChangeNameActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int setthislayout() {
        return R.layout.changename_layout;
    }
    ...
    private void changpasswordIndex() {
        ...
        VolleyRequest.RequestPost(context, UrlUtils.BASE_URL + "self/eduser", "self/eduser", params, new VolleyInterface(context) {
            @Override
            public void onMySuccess(String result) {
                ...
                try {
                    ...
                    if ("1".equals(String.valueOf(stuBean.getStatus())) || "211".equals(String.valueOf(stuBean.getStatus()))) {
                        SpUtil.putAndApply(context, "username", name);
