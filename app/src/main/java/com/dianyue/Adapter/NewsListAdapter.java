...
public class NewsListAdapter extends RecyclerView.Adapter<NewsListAdapter.ViewHolder> {
    ...
    Context mContext;
    private ArrayList<NewsListBean.ListBean.ListsBean> datas = new ArrayList();

    public ArrayList<NewsListBean.ListBean.ListsBean> getDatas() {
        return datas;
    }

    public NewsListAdapter(List<NewsListBean.ListBean.ListsBean> list, Context context) {
        this.datas = (ArrayList<NewsListBean.ListBean.ListsBean>) list;
