...
public class NewsSearchListAdapter extends RecyclerView.Adapter<NewsSearchListAdapter.ViewHolder> {
    ...
    Context mContext;
    private ArrayList<NewsSearchBean.MsgBean> datas = new ArrayList();

    public ArrayList<NewsSearchBean.MsgBean> getDatas() {
        return datas;
    }

    public NewsSearchListAdapter(List<NewsSearchBean.MsgBean> list, Context context) {
        this.datas = (ArrayList<NewsSearchBean.MsgBean>) list;
