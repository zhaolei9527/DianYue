...
public class SakuraLinearLayoutManager extends LinearLayoutManager {
    ...
    public SakuraLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
        this.view = null;
    }

    public SakuraLinearLayoutManager(RecyclerView view) {
        super(view.getContext());
        this.view = view;
        this.overScrollMode = ViewCompat.getOverScrollMode(view);
    }

    public SakuraLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
